...
class SolarSystem:
    def __init__(self, size):
        ...
        # self.ax.set_xlim(-self.size / 50, self.size / 50)
        # self.ax.set_ylim(-self.size / 50, self.size / 50)
...
class SolarSystemBody:
    ...
    def accelerate_due_to_gravity(self, other):
        ...
        force_mag = self.mass * other.mass / (distance_mag**2) # Not using Gravitational Constant yet
...
class Planet(SolarSystemBody):
    colours = itertools.cycle([(1, 0, 0), (0, 1, 0), (0, 0, 1), (0.5, 0, 0.5), (0.5, 0.5, 0), (0, 0.5, 0.5)])
    def __init__(
        self,
        solar_system,
        mass=10,
